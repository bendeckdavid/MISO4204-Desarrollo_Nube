/**
 * Escenario 1: Prueba de Capacidad de la Capa Web - Entrega 5
 *
 * Objetivo: Determinar el número máximo de usuarios concurrentes
 * que puede soportar la aplicación usando ECS con Fargate.
 * 
 * Estrategia: Realizar pruebas comparativas con la entrega 4 (EC2 + ASG)
 *
 * Cambios vs Entrega 4:
 * - Web y Workers usan ECS Fargate en lugar de EC2 con autoescalado
 */
...
const BASE_URL = __ENV.BASE_URL || 'http://anb-video-alb-1627965266.us-east-1.elb.amazonaws.com';
...
export function handleSummary(data) {
  return {
    'capacity-planning/results-entrega5/escenario1_summary.json': JSON.stringify(data),
...
function textSummary(data, options) {
  let output = '\n';
  output += '================================================================================\n';
  output += '  ESCENARIO 1: CAPA WEB - ENTREGA 5 (SQS) - RESULTADOS FINALES\n';
  output += '================================================================================\n\n';
