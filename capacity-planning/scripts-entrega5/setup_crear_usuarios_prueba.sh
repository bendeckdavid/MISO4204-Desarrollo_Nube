...
BASE_URL="${BASE_URL:-http://anb-video-alb-1627965266.us-east-1.elb.amazonaws.com}"
...
echo "   BASE_URL=\"$BASE_URL\" k6 run capacity-planning/scripts-entrega5/test_escenario1_web.js"
echo ""
